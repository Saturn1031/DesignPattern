...
public class SafeFrame extends Frame implements ActionListener, Context {
    ...
    private Button buttonCCTV = new Button("CCTV"); // 권나래: CCTV 버튼 추가
    ...
    public SafeFrame(String title) {
        ...
        panel.add(buttonCCTV); // 권나래: 패널에 CCTV 버튼 추가
        ...
        buttonCCTV.addActionListener(this); // 권나래: CCTV 버튼 리스너 설정
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == buttonUse) {		// 금고 사용 버튼
            ...
            state.doPhone(this);
        } else if (e.getSource() == buttonCCTV) { // 권나래: CCTV 버튼을 누르면 실행
            state.doCCTV(this);
